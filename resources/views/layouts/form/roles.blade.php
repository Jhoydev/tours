<div class="form-row px-5">
    ...
    <input type="hidden" name="" id="user_role_id" value="{{ $method == 'PUT' ? '' : '' }}">
    <input type="hidden" id="user_id" value="{{ $method == 'PUT' ? $user->id : '' }}">
    <input type="hidden" name="permissions_id" :value="checked_permissions">
    ...
    <div class="col-12" v-if="rolepicked">
        <hr>
        <h4 class="text-center"><span class="fa fa-flag"></span> Permisos</h4>
        <div v-for="permission in permissions">
            <label class="switch switch-icon switch-pill switch-primary-outline-alt"
                   v-bind:class="{ 'switch-secondary-outline-alt': permission.disabled }">
                <input type="checkbox" class="switch-input" v-model="permission.checked"
