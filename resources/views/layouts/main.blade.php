        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
               aria-expanded="false" style="position: relative;padding-left: 50px">
                <img style="width: 32px; height: 32px; position: absolute;top: -6px; left: 10px; border-radius: 50%" class="img-fluid" src="{{ route('user.avatar',['company' => Auth::user()->company_id, 'id' => Auth::user()->id ]) }}" alt="">
    ...
    <div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('customer') }}"><i class="fa fa-users"></i> Clientes</a>
                </li>
                <li class="nav-item">
