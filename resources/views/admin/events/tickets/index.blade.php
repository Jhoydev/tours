                        ...
                        <div class="row justify-content-center">
                            ...
                            @else
                                <div class="col-12 text-center">
                                    ...
                                    <button class="btn btn-success rounded mr-5" data-toggle="modal" data-target="#modal_ticket" data-url_post="{{ route('admin.events.tickets.store',['event' => $event->id]) }}"><i class="fa fa-plus"></i> Nuevo Ticket</button>
                                </div>
                            @endif
                        </div>
                    </div>
