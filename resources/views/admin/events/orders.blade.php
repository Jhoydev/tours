                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            @include('admin.events.import_form')
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="text-right">
                                    ...
                                    @elseif(trim($order->payu_order_id) == "")
                                        ...
                                        @endif
                                    @endif
                                    <a class="" href="{{ route('admin.events.orders.details',['event' => $event->id,'order' => $order->id]) }}"><i class="fa fa-sign-in-alt" aria-hidden="true"></i> Detalles</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
