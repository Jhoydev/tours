...
<li class="nav-item">
    ...
    <div class="collapse" id="icons" style="">
        <ul class="nav flex-column sub-menu">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.events.show', ['events' => $event->id]) }}"><i class="fa fa-home menu-icon"></i><span class="menu-title">Tablero</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.event.customers',['id' => $event->id]) }}"><i class="fa fa-users menu-icon"></i><span class="menu-title">Asistentes</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.event.orders',['id' => $event->id]) }}"><i class="fa fa-shopping-cart menu-icon"></i><span class="menu-title">Ordenes</span></a>
            </li>
            @can('event.edit')
                <li class="nav-item">
