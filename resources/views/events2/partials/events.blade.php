            ...
            <table id="table_datatable" class="table table-hover fade">
                ...
                @foreach($events as $event)
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ route('events.show',['event' => $event->id]) }}" class="btn btn-sm btn-primary"><i class="fas fa-sign-in-alt"></i> </a>
                            @can('event.edit')
                            <a href="{{ route('events.edit',['event' => $event->id]) }}" class="btn btn-sm btn-light"><i class="fa fa-cog"></i> </a>
                            @endcan
                        </td>
                    </tr>
                @endforeach
